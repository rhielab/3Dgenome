...
#We first try KR and BP at 1 to see whether hic file contains chr or no chr in the name.
#After so, we run through chr1- chrX, and see whether chrY is present in the hic file or not.
try:
